...
$txt['Yourls_settingsDesc'] = 'From here you can configure the SMF - YOURLS integration. <br /> Keep in mind that this mod uses a third party script and sometimes there could be lags as it depends on an external server response, the mod performs a check every 5 minutes to make sure the external server is up and running, if not, the mod would be disable and an error log will be filled to prevent any downtime in your forum.';
